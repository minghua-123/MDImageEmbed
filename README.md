...
### 版本 2.6.2 (2026-05-17)
- 修复：增加 CSS 选择器优先级（使用 !important），强制覆盖 Obsidian 默认样式
- 修复：输入框添加 box-sizing: border-box 确保宽度计算正确
- 优化：给所有 flex 容器添加 max-width: 100% 和 width: 100%

### 版本 2.6.1 (2026-05-17)
- 修复：导出对话框中"导出路径"和"导出文件名"输入框过短，无法完整显示长路径的问题
- 优化：输入框自适应面板宽度，移除固定最小宽度限制
- 优化：大屏对话框宽度从 600px 增至 650px
